...
export const intentPages = [
  ...
  },
  {
    ...
    description:
      'Test gratuito de oposiciones TAI con 548 preguntas propias, explicaciones, filtros por bloque y práctica adaptativa.',
    intro:
    ...
    sections: [
      [
        'Qué incluye el test',
        'Preguntas de cuatro opciones, explicación después de responder, elección por bloque o tema, sesión adaptativa y minijuegos de repaso.',
      ],
      [
        'Cómo aprovechar cada intento',
        'No busques solo acertar: lee el distractor que te ha llamado la atención y vuelve a la explicación. La práctica con error es la que más adelante aparece en el examen.',
      ],
      [
        'Privacidad',
        'El test funciona en localStorage. No necesitas registro y puedes exportar tu progreso desde Ajustes.',
      ],
    ],
